      ...
      >
        <div className="px-4 py-5 border-b border-gray-700 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">โรงเรียนภูเขียว</p>
          </div>
          <button
        ...
        <div className="px-4 py-3 border-t border-gray-700">
          <p className="text-xs text-gray-500">
            นักเรียน {summary ? summary.total_students.toLocaleString() : "…"} ·
            ครู {summary ? summary.total_teachers.toLocaleString() : "…"}
          </p>
        </div>
      </aside>
